...
describe(UniqueIdService.name, () => {
  ...
  it(`#${UniqueIdService.prototype.generateUniqueIdWithPrefix.name} should throw when called with empty`, () => {
    ...
    //quando se espera uma excessao, é preciso utilizar uma funcao para identificar;

    // toBeTrue: só testa tipo primitivo - tipo literal;
    // toBe: apenas comparacao;
    // toBeTruthy: espera que a expressao passada seja verdadeira
  });
});
